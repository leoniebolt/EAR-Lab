...
All experiments were conducted using the M2DGR dataset, which provides synchronized multi-sensor data including:
...
Select a dataset sequence (e.g. hall_03) containing the ROS1 rosbag files.
...
Each algorithm is implemented in a separate branch or repository to ensure fair and reproducible comparison.
